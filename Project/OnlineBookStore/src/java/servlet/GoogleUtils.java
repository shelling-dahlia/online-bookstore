...
public class GoogleUtils {
    ...
    public static String getToken(final String code, ServletContext context) throws ClientProtocolException, IOException {
        String response = Request.Post(Config.GOOGLE_LINK_GET_TOKEN)
                ...
                context.log("google json1: " +  response);
        JsonObject jobj = new Gson().fromJson(response, JsonObject.class);
        context.log("google json: " +  jobj.get("access_token"));
